    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('borrowed', 'Borrowed'), ('late', 'Late'), ('returned', 'Returned'), ('returned_late', 'Returned Late')], default='borrowed', max_length=255, verbose_name='Status')),
                ('books', models.ManyToManyField(to='books.Book')),
                ('reader', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='books.reader')),
            ],
            options={
                'verbose_name': 'Borrow',
